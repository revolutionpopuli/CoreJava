...
public class PizzaSiparisHatti {
    ...
    // Kullanıcıya Pizza için 1-Small,2-Medium,3-Large, 4-Goster, 5-Çıkış
    ...
    public static void menu () {//TODO:Test Driven Development
        System.out.println("*****PIZZA MENU******");
        System.out.println("1-Small");
        System.out.println("2-Medium");
        System.out.println("3-Large");
        System.out.println("4-Sepet Göster");
    ...
    //TODO:bu programı Pizza Clasında verilen özellikleri de kapsayacak şekilde yazınız
}