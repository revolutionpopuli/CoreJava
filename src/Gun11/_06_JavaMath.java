...
public class _06_JavaMath {
    public static void main(String[] args) {
        ...
        System.out.println("a ve b nin büyük olanı="+Math.max(a,b));//4
        ...
        System.out.println("roo-und 3.5="+Math.round(3.5));//4
        ...
        System.out.println("ceil 3.1=" +Math.floor(3.1));//bu rakamdan küçük en yakın tam sayı-3
        System.out.println("ceil 3.5=" +Math.floor(3.5));//bu rakamdan küçük en yakın tam sayı-3
    }
}
